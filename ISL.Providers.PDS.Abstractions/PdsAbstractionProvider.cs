...
namespace ISL.Providers.PDS.Abstractions
{
    public partial class PdsAbstractionProvider : IPdsAbstractionProvider
    {
        ...
        /// </summary>
        /// <returns>
        /// A PDS request where the NHS Number has been replaced by the real NHS Number and additional details populated.
        ...
        public ValueTask<PdsRequest> PatientLookupByDetailsAsync(PdsRequest pdsRequest) =>
        TryCatch(async () =>
        {
            return await this.pdsProvider.PatientLookupByDetailsAsync(pdsRequest);
        });
        ...
        /// </summary>
        /// <returns>
        /// A PDS request where the name, DOB, Postcode and contact information are populated.
        /// If the PDS search could not happen due to search parameters being invalid, the Nhs Number will be
        ...
        /// <exception cref="PdsDependencyProviderException" />
        /// <exception cref="PdsServiceProviderException" />
        public ValueTask<PdsRequest> PatientLookupByNhsNumberAsync(PdsRequest pdsRequest) =>
        TryCatch(async () =>
        {
            return await this.pdsProvider.PatientLookupByNhsNumberAsync(pdsRequest);
        });
    }
}
