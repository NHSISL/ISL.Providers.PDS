...
namespace ISL.Providers.PDS.Abstractions.Tests.Unit
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionWhenTypeIPdsValidationException()
        {
            // given
            ...
            this.pdsMock.Setup(provider =>
                provider.PatientLookupByDetailsAsync(It.IsAny<PdsRequest>()))
                    .ThrowsAsync(somePdsValidationException);

            // when
            ValueTask<PdsRequest> patientLookupTask =
                this.pdsAbstractionProvider
                    .PatientLookupByDetailsAsync(It.IsAny<PdsRequest>());
        ...
        [Fact]
        public async Task ShouldThrowDependencyValidationExceptionWhenTypeIPdsDependencyValidationException()
        {
            // given
            var someException = new Xeption();
        ...
        [Fact]
        public async Task ShouldThrowDependencyExceptionWhenTypeIPdsDependencyException()
        {
            // given
            var someException = new Xeption();
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionWhenTypeIPdsServiceException()
        {
            // given
            var someException = new Xeption();
